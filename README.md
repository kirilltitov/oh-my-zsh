...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/kirilltitov/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/kirilltitov/oh-my-zsh/master/tools/install.sh -O -)"
```
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/kirilltitov/oh-my-zsh/master/tools/install.sh)"
```
